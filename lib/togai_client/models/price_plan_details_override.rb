...
module TogaiClient
  class PricePlanDetailsOverride
    ...
    def list_invalid_properties
      ...
      if !@fixed_fee_rate_cards.nil? && @fixed_fee_rate_cards.length < 1
        invalid_properties.push('invalid value for "fixed_fee_rate_cards", number of items must be greater than or equal to 1.')
      end
    ...
    def valid?
      ...
      return false if !@fixed_fee_rate_cards.nil? && @fixed_fee_rate_cards.length < 1
      true
    end
    ...
    def fixed_fee_rate_cards=(fixed_fee_rate_cards)
      ...
      if fixed_fee_rate_cards.length < 1
        fail ArgumentError, 'invalid value for "fixed_fee_rate_cards", number of items must be greater than or equal to 1.'
      end
