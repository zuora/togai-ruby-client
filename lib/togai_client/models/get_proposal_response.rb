...
module TogaiClient
  class GetProposalResponse
    ...
    attr_accessor :proposal_response_date
    ...
    def self.attribute_map
      {
        ...
        :'proposal_response_date' => :'proposalResponseDate'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `TogaiClient::GetProposalResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `TogaiClient::GetProposalResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'payment_mode')
        ...
        self.payment_mode = nil
      end

      if attributes.key?(:'proposal_response_date')
        self.proposal_response_date = attributes[:'proposal_response_date']
      end
    end
    ...
    def valid?
      ...
      payment_mode_validator = EnumAttributeValidator.new('String', ["PREPAID", "POSTPAID"])
    ...
    def payment_mode=(payment_mode)
      validator = EnumAttributeValidator.new('String', ["PREPAID", "POSTPAID"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          proposal_response_date == o.proposal_response_date
    end
    ...
    def hash
      [id, account_id, price_plan_id, quantity, rate_card_quantities, idempotency_key, price_plan_version, purchase_plan_override, association_override, wallet_topup_details, created_at, updated_at, effective_from, effective_until, expiry_date, price, invoice_id, invoice_currency, status, type, comment, payment_mode, proposal_response_date].hash
    end
