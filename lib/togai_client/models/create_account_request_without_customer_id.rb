...
module TogaiClient
  ...
  class CreateAccountRequestWithoutCustomerId
    ...
    def hash
      [id, name, invoice_currency, aliases, account_aliases, address, primary_email, billing_information, settings, net_term_days, metadata, tags, status].hash
    end
