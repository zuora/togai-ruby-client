...
module TogaiClient
  class PricingScheduleWithPricePlanId
    attr_accessor :id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `TogaiClient::PricingScheduleWithPricePlanId` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `TogaiClient::PricingScheduleWithPricePlanId`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'is_overriden')
        self.is_overriden = attributes[:'is_overriden']
      else
        self.is_overriden = nil
      end
    ...
    def list_invalid_properties
      ...
      if @is_overriden.nil?
        invalid_properties.push('invalid value for "is_overriden", is_overriden cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @is_overriden.nil?
    ...
    def hash
      [id, price_plan_details, start_date, end_date, version, pricing_rules, is_overriden, price_plan_id, price_plan_name, price_plan_info].hash
    end
