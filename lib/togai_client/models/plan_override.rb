...
module TogaiClient
  ...
  class PlanOverride
    ...
    def self.openapi_types
      {
        ...
        :'price_plan_details_override' => :'PricePlanDetailsOverride',
        :'pricing_rules_override' => :'Array<PricingRule>',
        :'start_date' => :'Time',
        :'end_date' => :'Time'
      }
    end
    ...
    def hash
      [id, price_plan_id, price_plan_name, price_plan_details_override, pricing_rules_override, start_date, end_date].hash
    end
