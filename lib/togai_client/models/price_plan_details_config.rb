...
module TogaiClient
  ...
  class PricePlanDetailsConfig
    ...
    attr_accessor :pricing_cycle_ordinal
    ...
    def self.attribute_map
      {
        ...
        :'pricing_cycle_ordinal' => :'pricingCycleOrdinal'
      }
    end
    ...
    def self.openapi_types
      {
        :'mode' => :'String',
        :'price_plan_details' => :'CreatePricePlanDetails',
        :'price_plan_id' => :'String',
        :'account_id' => :'String',
        :'effective_on' => :'Time',
        :'pricing_cycle_ordinal' => :'Integer'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `TogaiClient::PricePlanDetailsConfig` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `TogaiClient::PricePlanDetailsConfig`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'pricing_cycle_ordinal')
        self.pricing_cycle_ordinal = attributes[:'pricing_cycle_ordinal']
      end
    end
    ...
    def valid?
      ...
      mode_validator = EnumAttributeValidator.new('String', ["CUSTOM", "PRICE_PLAN", "ACCOUNT"])
    ...
    def mode=(mode)
      validator = EnumAttributeValidator.new('String', ["CUSTOM", "PRICE_PLAN", "ACCOUNT"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          pricing_cycle_ordinal == o.pricing_cycle_ordinal
    end
    ...
    def hash
      [mode, price_plan_details, price_plan_id, account_id, effective_on, pricing_cycle_ordinal].hash
    end
