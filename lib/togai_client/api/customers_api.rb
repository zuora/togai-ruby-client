...
module TogaiClient
  class CustomersApi
    ...
    # @param create_customer_contact_request [CreateCustomerContactRequest] Payload to create a contact for a customer
    # @param [Hash] opts the optional parameters
    # @return [CreateCustomerContactResponse]
    def create_customer_contact(customer_id, create_customer_contact_request, opts = {})
      data, _status_code, _headers = create_customer_contact_with_http_info(customer_id, create_customer_contact_request, opts)
      data
    end
    ...
    # @param create_customer_contact_request [CreateCustomerContactRequest] Payload to create a contact for a customer
    # @param [Hash] opts the optional parameters
    # @return [Array<(CreateCustomerContactResponse, Integer, Hash)>] CreateCustomerContactResponse data, response status code and response headers
    def create_customer_contact_with_http_info(customer_id, create_customer_contact_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CustomersApi.create_customer_contact ...'
      end
      # verify the required parameter 'customer_id' is set
      if @api_client.config.client_side_validation && customer_id.nil?
        fail ArgumentError, "Missing the required parameter 'customer_id' when calling CustomersApi.create_customer_contact"
      end
      if @api_client.config.client_side_validation && customer_id.to_s.length > 50
        fail ArgumentError, 'invalid value for "customer_id" when calling CustomersApi.create_customer_contact, the character length must be smaller than or equal to 50.'
      end

      # verify the required parameter 'create_customer_contact_request' is set
      if @api_client.config.client_side_validation && create_customer_contact_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_customer_contact_request' when calling CustomersApi.create_customer_contact"
      end
      # resource path
      local_var_path = '/customers/{customer_id}/contacts'.sub('{' + 'customer_id' + '}', CGI.escape(customer_id.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(create_customer_contact_request)

      # return_type
      return_type = opts[:debug_return_type] || 'CreateCustomerContactResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['bearerAuth']

      new_options = opts.merge(
        :operation => :"CustomersApi.create_customer_contact",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CustomersApi#create_customer_contact\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
